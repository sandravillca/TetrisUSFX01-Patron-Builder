...
#include "ConstructorEscenario2.generated.h"

UCLASS()
class TETRISUSFX01_API AConstructorEscenario2 : public AActor, public IConstructorEscenario
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	AConstructorEscenario2();
