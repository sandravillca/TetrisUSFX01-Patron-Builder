...
void ABoard::Tick(float DeltaTime)
{
    ...
    case PS_MOVING:
        CoolLeft -= DeltaTime;
        //CurrentPiece->ScorePuntos = CurrentPiece->ScorePuntos + 1;
...
void ABoard::CambiarNivel()
{
    ...
    {
    case 0:
        //ConstructorEscenario1= GetWorld()->SpawnActor<AConstructorEscenario1>(this->GetActorLocation(), FVector(0.0f, 0.0f, 0.0f), FRotator(0.0f, 0.0f, 0.0f));
        ConstructorEscenario1 = GetWorld()->SpawnActor<AConstructorEscenario1>(AConstructorEscenario1::StaticClass());
        Director->SetConstructorEscenarioPlano(ConstructorEscenario1);
        GEngine->AddOnScreenDebugMessage(-1, 3, FColor::Green, TEXT("Se genero un Escenario 1 "));
        break;
    case 1:
        ConstructorEscenario2 = GetWorld()->SpawnActor<AConstructorEscenario2>(AConstructorEscenario2::StaticClass());
        Director->SetConstructorEscenarioPlano(ConstructorEscenario2);
        GEngine->AddOnScreenDebugMessage(-1, 3, FColor::Green, TEXT("Se genero un Escenario 2 "));
        break;
    case 2:
        ConstructorEscenario3 = GetWorld()->SpawnActor<AConstructorEscenario3>(AConstructorEscenario3::StaticClass());
        Director->SetConstructorEscenarioPlano(ConstructorEscenario3);
        GEngine->AddOnScreenDebugMessage(-1, 3, FColor::Green, TEXT("Se genero un Escenario 3 "));
        break;
    }
    Random += 1;

    Director->ConstruirEscenarioPlano();

    AEscenarioPlano* EscenarioPlano = Director->GetEscenarioPlano();
    CurrentEscenario = EscenarioPlano;

    CurrentEscenario->SpawnBlocks();
}